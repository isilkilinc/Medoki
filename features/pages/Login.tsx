        ...
        <div className="glass-card flex flex-col gap-5 p-6 rounded-3xl border border-border/50 bg-background/60 backdrop-blur-xl shadow-xl">
          ...
          <div className="mb-2">
            <h2 className="text-lg font-semibold">
              {isForgotPassword ? "Şifremi Sıfırla" : isLogin ? "Hoş Geldiniz" : "Hesap Oluşturun"}
            </h2>
          ...
          {isForgotPassword ? (
            <form onSubmit={handleResetPassword} className="flex flex-col gap-4">
              ...
              >
                {isLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : "Sıfırlama Linki Gönder"}
              ...
              <button
                ...
                className="text-sm font-medium text-muted-foreground hover:text-foreground flex items-center justify-center gap-1 mt-2 transition-colors"
              >
          ...
          <div className="text-sm text-muted-foreground leading-relaxed space-y-3 max-h-64 overflow-y-auto pr-1">
            {modalType === "kvkk" ? (
              ...
              <>
                ...
                <p>Uygulama; sağlık bilgisi sağlama amacıyla tasarlanmış olup tıbbi tavsiye niteliği taşımamaktadır.</p>
              </>
            )}
          </div>
